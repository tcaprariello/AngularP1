...
export class ProductListComponent {
    ...
    ngOnInit(): void {
        ...
        if (isNaN(catID)) {
            ...
            this.products = this.products.filter(p => p.Product_Category == catID);
            console.table(this.products);
        }
    } //end of ngOnInit

    //private function to load the Yeti data Array
    private loadYetiProductsArray() {
        ...
        var sortedArray: IYetiProduct[] = unsortedArray.sort((a,b) => {
            if( a.Product_Name.toUpperCase() < b.Product_Name.toUpperCase()) return -1;
            else if (a.Product_Name.toUpperCase() > b.Product_Name.toUpperCase()) return 1;
            else return 0;
        });
        //console.table(this.products);
